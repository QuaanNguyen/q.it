...
Issues and specs for this repo live as GitHub issues on [QuaanNguyen/q.it](https://github.com/QuaanNguyen/q.it). Use the `gh` CLI for all operations.
...
Create a GitHub issue on `QuaanNguyen/q.it`.
